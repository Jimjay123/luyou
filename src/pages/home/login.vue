<template>
  <LoginBox :show="show">
    ...
    <!--验证码登录 start-->
    <LoginTab :type="'captcha'"></LoginTab>
    <!--验证码登录 end-->

    <div :class="inpBoxClass">
      <!-- <SelBox class="select" :selVal="selVal"></SelBox> -->
      <div class="select">
    ...
    <!--提交按钮 start-->
    <BtnBox :signClick="signClick" :signBtn="signBtn"></BtnBox>
    <!--提交按钮 end-->
  ...
  @Emit signClick() {
    ...
    getMemLogMobCap({
      ...
      if (res.code == "0") {
        ...
        memberidFun(res.memberId); //设置memberId缓存
        let path = "/Uncertified"; //默认未认证
