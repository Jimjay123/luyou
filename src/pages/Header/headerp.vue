 ...
 * @version: 
 * @Author: pengwanchong
 * @Date: 2019-09-18 09:18:42
 * @LastEditors: pengwanchong
 * @LastEditTime: 2019-12-05 10:42:53
 -->
<template>
  <el-header clearfix>
    <div class="header-box">
      <div class="header">
        ...
        <el-menu
          ...
          @select="handleSelect"
        >
          <el-menu-item index="/StudentMain" v-on:click="handleClick1(card,1)">
            首页
            <i v-if="headerTab===1"></i>
          </el-menu-item>
          <el-menu-item index="/StudentCour" v-on:click="handleClick1s1(card,2)">
            我的课程
            <i v-if="headerTab===2"></i>
          </el-menu-item>
          <el-menu-item index="/student/studentList" v-on:click="handleClick1s2(card,3)">
            我的群组
            <i v-if="headerTab===3"></i>
          </el-menu-item>
          <el-menu-item index="/student/ncesCenter" v-on:click="handleClick1s3(card,4)">
            个人中心
        ...
        <div class="icon">
          ...
          <span
            class="three"
            v-on:mouseenter="mouseoversFun(wrz)"
            v-on:mouseleave="mouseleavesFun(wrz)"
            v-on:click="handleClick(card)"
          >
            <div class="bb">
              <div class="hover">
                <img :src="avatar || require('../../assets/img/touxiang.svg')" class="img3" />
              </div>
            </div>
              ...
              <div class="ks">
                <div class="gr" @click="PersonalCenter">
                  <div class="jh">
                    ...
                    <div class="rz" v-if="listz.identifiedRoleType === 3">创作者</div>
        ...
        <div class="kkp" v-if="wrz === 0 ? true : false ">
...
export default {
  ...
  methods: {
    ...
    teachersClick() {
      this.$router.push({
        path: "/teachers/studentAttestation"
      });
    },
    teachersClick1() {
      this.$router.push({
  ...
  computed: {
    ...
    headerTab() {
      ...
      if (this.matchFun("/StudentMain")) {
        return 1;
      } else if (this.matchFun("/StudentCour")) {
        return 2;
      } else if (this.matchFun("/student/studentList")) {
        return 3;
      } else if (this.matchFun("/student/ncesCenter")) {
        return 4;
      }
    }
  }
