 ...
 * @version: 
 * @Author: pengwanchong
 * @Date: 2019-09-20 14:35:25
 * @LastEditors: pengwanchong
 * @LastEditTime: 2020-03-03 09:13:08
 -->
<template>
  <el-header clearfix>
    <div class="header-box">
      <div class="header clearfix">
        ...
        <div class="icon">
          <!-- 搜索  -->
          <div class="onez" @click="searchs(wrz)">
          ...
          <!-- 创作者中心start -->
          <div class="creators" @click="jumpPage" v-if="creators">
            <div class="text">创作者中心</div>
          </div>
          <!-- 创作者中心end -->
          ...
          <div
            class="three"
            v-on:mouseenter="mouseovers(wrz)"
            v-on:mouseleave="mouseleaves(wrz)"
    ...
    memberidentifyRoleType({})
      .then(res => {
        if (res.code == "0") {
          ...
          this.creators = res.authorPermissionFlag;
          if (this.wrz == 2) {
            this.title = "我的课程";
          }
          ...
          if (this.$route.path == "/Uncertified") {
            if (this.wrz === 3) {
