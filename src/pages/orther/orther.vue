...
export default class Orther extends Vue {
  //src = 'http://192.168.10.21:8010/emp/index.html?actor={"name":"xxx","mailto":"xxx@luyouor.com"}&endpoint=http://192.168.10.21:9000/luyou-ms-auth-server/learningRecordStore/&token=123456&content_token=1-1-67';
  src = "";
  btnShow = false;
  dialogShow = false;
  btnContext = "";
