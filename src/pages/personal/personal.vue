 ...
 * @version: 
 * @Author: pengwanchong
 * @Date: 2019-09-23 09:13:32
 * @LastEditors: pengwanchong
 * @LastEditTime: 2019-12-05 16:14:28
 -->
<template>
  <div>
    <el-container>
            ...
            <div class="first">
              ...
              >
                ...
                <el-form-item label="自我介绍" prop="introduction" label-width="79px">
                  <el-col :span="input_width" class="el-cols" style="width:759px;height:148px;">
                    <el-input
                      style="width:759px;height:148px;overflow: hidden;padding:5px"
                      type="textarea"
                      placeholder="请输入内容"
