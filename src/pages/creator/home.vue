  ...
  @Emit getCourAndChaAmountFun() {
    ...
    getCourAndChaAmount(data).then(res => {
      if (res.code == 0) {
        let data = res.data;
        this.censusCount = [
          data.totalAmount || 0, //全部
          data.editAmount || 0, //编辑中
          data.applyAmount || 0, //审核中
          data.publishAmount || 0, // 已发布
          data.expressAmount || 0 // 已转审
        ];
      } else {
        tipsFail(res.msg);
      }
