  ...
  <div class="title-sket" :style="bgStyle">
    <div class="quest">
      ...
      <ul class="options-box clearfix">
        ...
        <!-- 'isRightBg':isRightBg, -->
        <!-- 'isErrorBg':isErrorBg, -->
        <!-- v-if="isActiveIndex==index?isErrorBg:false" -->
        <li
          v-for="(item,index) in answer"
          :key="index"
          :class="{'bg':true,'isRightBg':isActiveIndex===index?isRightBg:false,'isErrorBg':isActiveIndex===index?isErrorBg:false,'isHasBorder':isActiveIndex===index?isErrorBg||isRightBg:false,}"
          @click="answerSelFun(index,item)"
        >
          <div
            class="singleLi"
            :class="{'isRightBg':isActiveIndex===index?isRightBg:false,'isErrorBg':isActiveIndex===index?isErrorBg:false}"
          >
            <div class="q-con">
              ...
              <img
                class="showIcon"
                v-if="isActiveIndex===index?isRightBg:false"
...
export default class ShowChoiceQuestionSket extends Vue {
  ...
  @EditMod.State("isActiveIndex") isActiveIndex; //选择题选中画板的下标
  @EditMod.Action("isActiveIndexHandle") isActiveIndexHandle; //选择题选中画板的下标  action
  ...
  answerSelFun(index, item) {
    ...
    let isActiveIndex = index;
    this.isActiveIndexHandle({
      isActiveIndex
    });
