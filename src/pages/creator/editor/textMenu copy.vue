...
export default class TextMenu extends Vue {
  ...
  //文字 背景
  get rightType() {
    return this.editList[this.editIndex].rightType || "背景";
  }
  ...
  @Emit selColValCb(val) {
    ...
    // this.setEditList("fontColor", val);
  ...
  bgColorCb(val) {
    ...
    //   pageContentRelId: obj.pageContentRelId, //关联id  查询时返回的
    //   backgroundColor: val,
    //   backgroundImageServerUrl: "",
    //   backgroundImageAttachId: ""
    // });
    // if (this.bgImg.src) {
    //   this.setEditList("bgImg", "");
    // }
  }
  ...
  @Emit selImgValCb(val, type) {
    ...
    if (!type) {
      ...
      // this.setEditList("bgImg", val);
      // let obj = this.editList[this.editIndex];
      // changeCouUpdPageContentFun({
      //   courseId: this.$route.query.courseId, //课程id
      //   pageId: obj.pageId, //页id
      //   pageContentRelId: obj.pageContentRelId, //关联id  查询时返回的
      //   backgroundImageServerUrl: val.src,
      //   backgroundImageAttachId: val.id,
      //   backgroundColor: ""
      // });
    } else if (type === "del") {
      //删除背景图片
  ...
  //对其方式回调方法
  // @Emit selAlignValCb(val) {
  //   this.setEditList("selAlignVal", val);
  // }
  ...
  @Emit selPositionValCb(val) {
    ...
    // this.setEditList("selPositionVal", val);
