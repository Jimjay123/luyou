  ...
  <div class="course-item">
    <div class="img-box">
      ...
      <div class="bg">
        ...
        <div class="copy icon-item" @click="moreFun(options)" v-if="options.state === 0">
          <div class="tips">
            更多
            <i class="icon-triangle"></i>
          </div>
        ...
        <div
          class="copys icon-item"
          v-if="options.state === 2 || options.state === 4 || options.state === 1"
        >
      ...
      <ul class="drop-down" v-show="dropDown" v-Clickoutside="outClick">
        <li v-if="options.state ===0" @click.stop="editFun(options)">
          <img :src="require('../../assets/creator/icon-set.svg')" class="mr" />
          <span>课程设置</span>
        </li>
        <li v-if="options.state ===0" @click="releaseFun(options)">
          <img :src="require('../../assets/creator/icon-release.png')" class="mr" />
          <span>发布</span>
        </li>
        <li v-if="options.state ===0" @click="transferTrial(options)">
          <img :src="require('../../assets/creator/icon-transfer.png')" class="mr" />
          <span>转审</span>
        </li>
        <li v-if="options.state === 0 || options.state === 1" @click.stop="copyFun">
          <img :src="require('../../assets/creator/icon-c.svg')" class="mr" />
          <span>复制</span>
        </li>
        <li v-if="options.state === 0" @click="editName('edit')">
          <img :src="require('../../assets/creator/icon-rename.svg')" class="mr" />
          <span>重命名</span>
        </li>
        <li @click="ddelFun('del')" v-if="options.state === 0">
          <img :src="require('../../assets/creator/icon-d.svg')" class="mr" />
          <span>删除</span>
        </li>
        <!--<li @click="recall('del')" v-if="options.state!==2">
          <img :src="require('../../assets/creator/icon-d.svg')" class="mr" />
          <span>撤回审核</span>
        </li>-->
      </ul>
    ...
    <div class="c-info">
      ...
      <div class="c-bottom clearfix">
        ...
        <div class="r-edit r-examine" v-if="options.state===1">
          <i class="icon-edit"></i>
          <span>审核中</span>
        </div>
        <div class="r-edit r-issue" v-if="options.state===2">
          <i class="icon-edit"></i>
          <span>已发布</span>
        </div>
        <div class="r-trial r-examine" v-if="options.state===4">
