...
<template>
  <div class="course-item">
    <div class="img-box">
      ...
      <div class="bg">
        <div class="preview icon-item" @click="previewFun(courseType)">
        ...
        <!-- <div v-if="options.courseType===2" class="bg-edit" @click="editCourse"></div>
        -->
        <div
      ...
      <ul class="drop-down" v-show="dropDown" v-Clickoutside="outClick">
        <li v-if="options.state===0" @click.stop="editFun">
          <img :src="require('../../assets/creator/icon-set.svg')" class="mr" />
          <span>课程设置</span>
        </li>
        <li @click.stop="copyFun">
