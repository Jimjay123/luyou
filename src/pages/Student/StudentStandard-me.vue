      ...
      <el-main>
        <div class="Analysis">
          ...
          <div class="fx">
            ...
            <span class="oo1" v-if="list.coursePlanType === 21 || list.coursePlanType === 22">标准课</span>
            <span class="oo1" v-if="list.coursePlanType === 25 || list.coursePlanType === 26">沙盘标准课</span>
...
import { planLearningDetail, memberRecommenList } from "../../service/groupApi";
import TopHeaderp from "../Header/headerp";
import { trimNumber, jumpOrther } from "../../utils/utils";
  ...
  created() {
    ...
    planLearningDetail({
      ...
      .then(res => {
        ...
        if (res.code == "0") {
          this.list = res.data;
          // if (this.list.coursePlanType === 1) {
          //   this.list.coursePlanType = "标准课";
          // } else {
          //   this.list.coursePlanType = "课程频道";
          // }
...
<<<<<<< HEAD
    // 去学习
    emit(ref, url, expireFlag, finishFlag, type) {
=======
    // 跳转第三方
    jumpPage(ref, url, expireFlag, finishFlag, type) {
>>>>>>> 1ea670147dd2b0aacb7a1f9ba44cfb55f3474618
