...
export default {
  ...
  mutations: {
    ...
    agreeFlagTextMut(state, item) {
      state.agreeFlagText = [...item.agreeFlagText]
    }
  },
  actions: {
    ...
    agreeFlagTextHandle(context, item) {
      context.commit('agreeFlagTextMut', item)
    }
  }
}
